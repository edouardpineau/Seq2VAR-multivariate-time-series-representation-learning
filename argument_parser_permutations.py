...
def argument_parser():
    ...
    parser.add_argument('--lag', action='store_true', default=1, help='Lag in the Granger causality model.')
...
def argument_parser_nri():
    ...
    parser_nri.add_argument('--epochs', type=int, default=3000, help='Number of epochs to train.')
    ...
    parser_nri.add_argument('--in-dim', type=int, default=1, help='Number of dimension per variate of the MTS')
    ...
    parser_nri.add_argument('--prior', action='store_true', default=True, help='Whether to use sparsity prior.')
